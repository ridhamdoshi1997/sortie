...
import { evaluateJobsAsync, evaluateJobChunk, evaluateJobFullAsync, generateResumeSuggestionAsync, sendMarketingBroadcastAsync, sendPushBroadcastAsync, generateGeoContentAsync, generateSuccessStoryAsync, sendFollowUpNudgesAsync, generateWeeklyBriefingsAsync, resetLifetimePlanUsagePeriodsAsync, archiveStaleInboxJobsAsync, reconcileStuckAgentRunsAsync, syncNewsItemsAsync, repairApplyLinksAsync, proactiveAtsCrawlAsync, proactiveWorkdayCrawlAsync, proactiveIcimsCrawlAsync, pruneCrawlCacheAsync, legitimacyRecheckAsync } from "../../../lib/inngest/functions";
...
export const { GET, POST, PUT } = serve({
    client: inngest,
    functions: [evaluateJobsAsync, evaluateJobChunk, evaluateJobFullAsync, generateResumeSuggestionAsync, sendMarketingBroadcastAsync, sendPushBroadcastAsync, generateGeoContentAsync, generateSuccessStoryAsync, sendFollowUpNudgesAsync, generateWeeklyBriefingsAsync, resetLifetimePlanUsagePeriodsAsync, archiveStaleInboxJobsAsync, reconcileStuckAgentRunsAsync, syncNewsItemsAsync, repairApplyLinksAsync, proactiveAtsCrawlAsync, proactiveWorkdayCrawlAsync, proactiveIcimsCrawlAsync, pruneCrawlCacheAsync, legitimacyRecheckAsync],
});