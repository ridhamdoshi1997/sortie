// lucide-react dropped brand/logo icons (no `Linkedin` export in this
// version) — inline glyph instead. fill="currentColor" so it still respects
// the surrounding element's Tailwind text color, not a hardcoded value.
