...
import { Activity, LayoutDashboard, Users, ShieldCheck, DollarSign, FileText, LifeBuoy, Megaphone, CreditCard, Cpu, Handshake, MessagesSquare, Link2 as LinkIcon } from "lucide-react";
...
// exist today — extend this list as each new section ships, per
// context/RESUME.md's admin-console expansion plan. Don't add a nav item
// for a page that doesn't exist yet.
const NAV_ITEMS = [
  { href: "/admin", label: "Home", icon: LayoutDashboard, exact: true },
  { href: "/admin/system", label: "System Health", icon: Activity, exact: false },
  ...
  { href: "/admin/interview", label: "Interview", icon: MessagesSquare, exact: false },
