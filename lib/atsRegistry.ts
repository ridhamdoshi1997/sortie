...
const GUESSABLE: AtsPlatform[] = ["greenhouse", "lever", "ashby", "smartrecruiters", "workable", "bamboohr"];  // dayforce excluded: session-priming makes blind guessing far too expensive
